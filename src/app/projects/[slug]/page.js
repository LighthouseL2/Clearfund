...
const SharePopup = ({ project, onClose }) => {
    ...
    const shareText = `I'm supporting "${project.name}" on ClearFund — driving real impact worldwide. Join me and tip to support this cause! 🌍💚`;
                            ...
                            <div className="bg-[#F8F9FA] rounded-[1.5rem] border border-gray-200 p-8 shadow-sm">
                                ...
                                <div className="mt-6 flex gap-12 border-t border-gray-100 pt-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-2xl font-black text-[#003E52] tracking-tighter">{Math.max(project.tipCount || 0, tips.length)}</div>
                                    </div>
                                </div>
