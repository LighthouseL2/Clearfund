        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-10
          ...
          {cards.map((card, index) => (
            ...
            >
              ...
              <Link href={card.link} className="w-[202.1923828125px] h-[52px] bg-green-700 text-white text-sm font-medium rounded hover:bg-green-800 transition flex items-center justify-center">
                {card.buttonText}
              </Link>
            </div>
          ))}
