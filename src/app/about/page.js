  ...
  return (
    <div className="bg-white text-black">
      ...
      <div className='w-full flex flex-wrap justify-between  px-[5%] lg:h-[80vh]'>
          <div className='lg:w-1/2 flex w-full flex-col mt-40 justify-center lg:justify-start'>
      ...
      backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
        <div className='py-[7rem]  lg:px-[10%] bg-black/75'>
          <div className='lg:h-[145px] bg-white mt-20 flex flex-wrap-reverse'>
          ...
          <div className='w-full py-5 px-5 lg:px-0 mt-20 flex gap-5 lg:gap-20'>
            <div className='flex flex-col gap-5'>
              ...
              <Link href={"https://discord.gg/4ePswVpuvd"}>
                <svg width="38" height="37" viewBox="0 0 38 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="19" cy="18.5" rx="19" ry="18.5" fill="white"/>
