                    ...
                    <div className="w-full flex flex-wrap gap-5 font-sans py-10">
                        ...
                        <div className="lg:w-[43%] w-full border rounded-[20px] p-6 flex flex-col justify-between text-center h-auto">
                            <div>
                                ...
                                <div>
                                    <Link href={"dashboard/donate"} className="mt-10 text-[#3A7768] py-2 px-13 font-black items-center justify-center rounded-full bg-[#95EED8] text-[16px] font-sans inline-flex">
                                        Donate Now
                                    </Link>
