  ...
  return (
    <nav className="px-[5%] flex justify-between items-end py-4 sticky top-0 z-50 bg-white ">
        ...
        <ul className="md:flex md:w-[45%] lg:w-[55%] xl:w-[65%] gap-10 hidden items-center">
            <li><Link className="font-sans font-bold text-[16px]" href={"https://github.com/LighthouseL2/Clearfund"}>Github</Link></li>
            <li><Link className="font-sans font-bold text-[16px]" href={"/about"}>About</Link></li>
            <li><Link className="font-sans font-bold text-[16px]" href={"https://clearfund.substack.com"}>Blog</Link></li>
        </ul>
