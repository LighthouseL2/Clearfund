        ...
        <form>
            ...
            <DialogContent className={"sm:max-w-[425px] max-w-[400px] p-10 bg-white  shadow-2xl"}>
                <DialogHeader className={"bg-white"}>
                    <DialogTitle className={"text-center font-bold font-sans text-[18px] text-black/50"}>Log in</DialogTitle>
                ...
                <div className='mt-6'>
                    <div className='border border-black flex justify-center items-center py-3 rounded-md opacity-50 mb-5'>
                    ...
                    <div className='border border-black/50 flex justify-center items-center py-3 rounded-md mb-5'>
                        <Link href="http://localhost:8080/api/auth/google" className='flex font-sans items-center gap-1'>
                            <Image
                                src={"/google.png"}
                                alt='google logo'
                                width={23.11}
                            ...
                            <span className='text-[16px] font-sans font-medium text-black/50'>Log in with Google</span>
                        </Link>
                    </div>
                ...
                <DialogFooter className={`w-full text-center ${errors ? "mt-0" : "mt-5"}`}>
                    <div className='w-full space-y-4'>
                        ...
                        >Continue</Button>
                        <p className='text-[13px] text-black/50 font-sans'>By logging in I agree to the <Link href='/terms' className='text-[#007AFF]'>Terms </Link>& <Link href='/privacy-policy' className='text-[#007AFF]'>Privacy Policy</Link></p>
                    </div>
                </DialogFooter>
            </DialogContent>
        </form>
