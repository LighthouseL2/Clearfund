            ...
            <DialogContent className={"sm:max-w-[425px] max-w-[400px] p-10 bg-white  shadow-2xl"}>
                <DialogHeader className={"space-y-10 bg-white"}>
                    ...
                    <div className='space-y-5 flex justify-center flex-col items-center'>
                        <p className='text-[16px] font-medium text-black/50'>Haven&apos;t signed up yet? <Link href="/?route=signup" className='text-[#007AFF]' onClick={(e) => {

                        }}>create account</Link></p>
                        {/* <img src="/projectLogo.png" alt="clearfund logo" /> */}
                        <Image
                            width={154.32}
                            height={33.07}
                            src={"/projectLogo.png"}
                ...
                <div className='space-y-5'>
                    ...
                    <div className='flex justify-end'>
                        <Link href="/?route=reset" className='underline text-[12px] font-medium text-black/50' >Forgot password</Link>
                    </div>
