                ...
                <DialogContent className={"sm:max-w-[425px] max-w-[400px] p-10 bg-white"}>
                    ...
                    <DialogFooter className={`w-full text-center ${!errors ? "mt-10" : "mt-0"}`}>
                        <div className='w-full space-y-4'>
                            ...
                            >Sign up</Button>
                            <p className='text-[13px] text-black/50 font-sans'>By signing up you agree with our <Link href='/terms' className='text-[#007AFF]'>Terms </Link>& <Link href='/privacy' className='text-[#007AFF] font-sans'>Privacy Policy</Link></p>
                        </div>
                    </DialogFooter>
                </DialogContent>
            </form>
