    ...
    <Dialog open={open} onOpenChange={setOpen}>
        <form>
            ...
            <DialogHeader className={"bg-white"}>
                ...
                <p className='text-center text-[16px] mt-2 mb-2'>or <Link href="/?route=login" className='text-[#007AFF]'>log in your account</Link></p>
            ...
            { errors &&
                <p className='text-[#FF3B30] text-[14px] w-[298px] mt-3'>You have already sign up with this email. Please login instead.</p>
            }
