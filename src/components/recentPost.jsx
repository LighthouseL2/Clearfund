    ...
    <div className="bg-white p-[5%] mb-20 lg:mb-20">
            ...
            <div className="grid lg:grid-cols-2 gap-5 mt-20 lg:h-[500px]">
                <Link href={"https://clearfund.substack.com"} target="_blank">
                    ...
                    <h1 className="text-[34px] font-sans leading-8 font-medium lg:w-3/4 mt-5">How ReFi is Changing the Way We Think About Money</h1>
                ...
                <Link href={"https://clearfund.substack.com/p/regen-coordi-nation-genesis-round"} target="_blank">
                    ...
                    <h1 className="text-[34px] font-sans leading-8 font-medium lg:w-3/4 mt-5">
