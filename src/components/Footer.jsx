  ...
  return (
    <footer className="bg-black pt-[5%] px-[5%] pb-5 text-white flex items-center justify-between flex-wrap">
        ...
        <div className="px-[5%] w-full lg:w-1/3">
            ...
            <div className="flex justify-between w-5/6">
                <div>
                    ...
                    <ul className="space-y-3 opacity-80 text-white">
                        <li>Home</li>
                        <li>FAQ</li>
                        <li>Blog</li>
                        <li>Contact</li>
        ...
        <div className="flex flex-wrap-reverse gap-5 mt-20 justify-between w-full pr-[2%]">
            <p className="text-xs opacity-70 text-white">© {today} ClearFund. All rights reserved</p>

            <div className="flex justify-between gap-20 opacity-70 text-white">
