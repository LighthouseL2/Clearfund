...
const MenuDropdown = ({openMenu, setOpenMenu, toggle, setToggle}) => {
  return (
    <div className={`md:hidden p-5 bg-white w-full h-[60vh] top-0 fixed z-50  transition-transform
        duration-300 left-0 ease-in-out ${!openMenu ? "-translate-y-full "
            ...
            <ul className="w-full bg-white h-fit space-y-5">
                <li className="hover:bg-white/50 block w-full p-3 rounded-md font-sans">
